 ...
 * Keeps the profileId-based API you had, so resources can be /profiles/{username}/documents/...
 */
public class DocumentService {
    ...
    public List<Document> getAllDocuments(String username) {
        return documents.values().stream()
                .filter(d -> d.getUsername() == username)
    ...
    public Document getDocument(String username, long documentId) {
        ...
        if (document == null || document.getUsername() != username) {
